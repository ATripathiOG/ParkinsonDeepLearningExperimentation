...
#The following two sections of code (drop_name_column and split_data_into_two)
...
#The following two sections of code (validation_loss_and_accuracy and graph_val_loss_and_accuracy)
